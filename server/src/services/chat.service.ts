...
- When the user asks to create MULTIPLE employees, use batch_create_employees instead of create_employee. Never call create_employee in a loop — use the batch tool.
