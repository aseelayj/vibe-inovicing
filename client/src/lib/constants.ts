...
export const NAV_ITEMS = [
  ...
  { labelKey: 'bankTransfers', path: '/bank-transfers', icon: 'ArrowRightLeft' },
  { labelKey: 'bankDeposits', path: '/bank-deposits', icon: 'PiggyBank' },
  { labelKey: 'chartOfAccounts', path: '/chart-of-accounts', icon: 'BookOpen' },
  { labelKey: 'journalEntries', path: '/journal-entries', icon: 'BookOpenCheck' },
